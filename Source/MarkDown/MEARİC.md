# MEARİC المعارج ( Yükselen Merdivenler ) 
---
- Sure Adı : MEARİC
- Sure No : 70
- Sure Tipi : meccan
...
```read
<strong>[1*]</strong> Güneş dürülmüş olacağı için bildiğimiz gün oluşmayacak.

	<strong>[2*]</strong> Kabirde yeniden yaratılış öncesi insanların ruhları göğe yükselecek.<br>
	&nbsp;
<strong>[*] </strong>Namaz kılan herkes burada istendiği gibi davranmadığından الْمُصَلِّينَ=el-musallîn kelimesinin başındaki el ال takısı ahd içindir. Namaz kılanlardan, burada anlatılan özellikleri taşıyanlar kastedilmektedir.

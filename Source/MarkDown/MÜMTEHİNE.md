# MÜMTEHİNE الممتحنة ( Sınanacak Olan ) 
---
- Sure Adı : MÜMTEHİNE
- Sure No : 60
- Sure Tipi : medinan
...
&nbsp;
	...
	&nbsp;
<strong>[*]</strong> Düşmanlarınızla barışmanızın ölçüsünü de(şartlarını da) Allah belirlemiştir.
...
<strong>[*] </strong>Yöneticilerin sadece doğru kararlarına itaat yükümlüğü var, yanlış kararlarda itaat edilmez.
```
---
## الممتحنة
```read
